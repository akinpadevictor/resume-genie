...
SERVICES = {
    ...
    "Resume Match": {
        ...
        "description": (
            ...
            "and get a focused match report."
        ),
    ...
    "Cover Letter": {
        "icon": "✉️",
        "description": (
            "Create a tailored, ATS-friendly cover letter "
            "for a specific role."
        ),
    ...
    "ATS Evaluation": {
        "icon": "📊",
        "description": (
            "Review your resume's ATS readiness, strengths, "
            "gaps, and career direction."
        ),
    ...
    "Career Coach": {
        "icon": "🧑‍💼",
        "description": (
            "Ask tailored career, interview, ATS, or job-search "
